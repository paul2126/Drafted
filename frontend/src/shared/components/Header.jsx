...
export const Header = ({ isLogin }) => {
  return (
    <div className="flex items-center top-0 left-0 z-50 w-full justify-between mb-8">
      {/* Logo and Navigation */}
      <div className="flex items-center gap-4">
        <Link to="/">
          <img
            src="https://storage.googleapis.com/tempo-image-previews/figma-exports%2Fuser_2zHSlEJBkEcQqWjXjpN0BzI5vib-1751527560601-node-I80%3A77%3B18%3A103-1751527559838.png"
            alt="Drafted Logo"
